    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < lectorParametros.getnFicheros(); i++) {
            ...
            //   Greedy_Aleatorio.GreedyAleatorio(Solucion, lector.getMatriz_Distancias().length, lector.getMatriz_Distancias(), Archivo_Greddy, Log_Greddy);
                Busqueda_Tabu.Busqueda_Tabu(Solucion, lector.getMatriz_Distancias().length, lector.getMatriz_Distancias(), lectorParametros.getIteraciones(), lectorParametros.getPorcentaje_Iteracciones(), lectorParametros.getEntorno(), lectorParametros.getReduccion(), lectorParametros.getEstancamiento(), lectorParametros.getTenencia(), lectorParametros.getOscilacion(), Archivo_Tabu, Log_Tabu);
