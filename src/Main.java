...
public class Main {
    ...
    public static void main(String[] args) {
       ...
       /* for (int i = 0; i < 5; i++) {
            System.out.println("ciudad"+i+", x: "+ lector_ch130.getMatriz_Ciudades().get(i).get(0) + ", y: "+ lector_ch130.getMatriz_Ciudades().get(i).get(1));
        }

        for (int i = 0; i < 5; i++) {
            for (int j = 0; j < 5; j++) {
                System.out.printf("i: "+i+",j: "+j+",distancia: "+lector_ch130.getMatriz_Distancias().get(i).get(j)+"  ");
            }
            System.out.println("");
        }
